...
export default function StockListPage() {
  ...
  const filteredAndSortedData = useMemo(() => {
    ...
    return filtered;
  }, [searchTerm, filterCluster, filterStatus, filterProduct, sortBy, sortOrder]);
  ...
  const stats = useMemo(() => {
    ...
    return { totalItems, totalHold, totalRelease, totalReceh, totalSalahCluster, totalQtyCarton, expiringSoon };
  ...
  const getProductMaster = (productCode: string) => {
      ...
      <div className="w-full max-w-full">
        ...
        <div className="bg-white rounded-xl shadow-lg p-3 sm:p-4 mb-3">
          <div className="flex items-center gap-2 sm:gap-3 mb-3">
            ...
            <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-800">Stock List (Pallet)</h1>
          </div>
